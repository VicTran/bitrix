...
<?$APPLICATION->IncludeComponent("webmin:menu", "horizontal_multilevel", array(
	"ROOT_MENU_TYPE" => "top",
	"MAX_LEVEL" => "2",
...
?>
		...
		<div id="content">
			...
			<div id="sidebar">
<?$APPLICATION->IncludeComponent("webmin:menu", "left", array(
	"ROOT_MENU_TYPE" => "left",
	"MENU_CACHE_TYPE" => "A",
	"MENU_CACHE_TIME" => "36000000",
	"MENU_CACHE_USE_GROUPS" => "Y",
...
<?
$APPLICATION->IncludeComponent("webmin:search.form", "flat", Array(
